...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('app', '0012_alter_flexpage_content'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='app.contactpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
