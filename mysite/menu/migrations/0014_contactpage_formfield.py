# Generated by Django 4.0.8 on 2022-12-01 11:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('menu', '0013_menuitem_social_media_name_alter_menuitem_icon_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='menu.contactpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
